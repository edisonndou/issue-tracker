...
@section('content')
    <div class="container">
        <div class="row mb-4">
            <div class="col-12">
                <h1 class="h2"><i class="bi bi-plus-circle"></i> New Tag</h1>
            </div>
        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="color" name="color" id="color" class="form-control form-control-color @error('color') is-invalid @enderror"
                                           value="{{ old('color', '#0d6efd') }}" style="width: 60px;">
                                    <input type="text" class="form-control" id="colorHex" placeholder="#0d6efd" value="{{ old('color', '#0d6efd') }}" disabled>
                                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <span class="tag-badge fs-5" id="preview" style="background-color: #0d6efd20; color: #0d6efd">
                            Preview Text
                        </span>
                    </div>
                </div>
